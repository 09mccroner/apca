...
/// A GET request to be made to the /v2/stocks/quotes/latest endpoint or /v2/stocks/trades/latest
#[derive(Clone, Debug, Eq, PartialEq, Serialize)]
pub struct GetReqTrades {
...
impl GetReqTradesInit {
  /// Create a [`GetReqTrades`] from a `GetReqTradesInit`.
  #[inline]
  pub fn init<I, S>(self, symbols: I) -> GetReqTrades
  where
...
/// A quote as returned by the /v2/stocks/trades/latest endpoint.
